...
BITstarConfigurator::BITstarConfigurator(const tinyxml2::XMLElement& xml_element)
{
  const tinyxml2::XMLElement* bit_star_element = xml_element.FirstChildElement("kBITstar");
  const tinyxml2::XMLElement* range_element = bit_star_element->FirstChildElement("Range");
  const tinyxml2::XMLElement* goal_bias_element = bit_star_element->FirstChildElement("GoalBias");
  const tinyxml2::XMLElement* delay_collision_checking_element = bit_star_element->FirstChildElement("DelayCollisionChe"
                                                                                                     "cking");
  ...
  if (range_element != nullptr)
  {
    ...
    status = tesseract_common::QueryStringText(range_element, range_string);
    if (status != tinyxml2::XML_NO_ATTRIBUTE && status != tinyxml2::XML_SUCCESS)
      throw std::runtime_error("OMPLConfigurator: BITstar: Error parsing Range string");

    if (!tesseract_common::isNumeric(range_string))
      throw std::runtime_error("OMPLConfigurator: BITstar: Range is not a numeric values.");
  ...
  if (goal_bias_element != nullptr)
  {
    ...
    status = tesseract_common::QueryStringText(goal_bias_element, goal_bias_string);
    if (status != tinyxml2::XML_NO_ATTRIBUTE && status != tinyxml2::XML_SUCCESS)
      throw std::runtime_error("OMPLConfigurator: BITstar: Error parsing GoalBias string");

    if (!tesseract_common::isNumeric(goal_bias_string))
      throw std::runtime_error("OMPLConfigurator: BITstar: GoalBias is not a numeric values.");
  ...
  if (delay_collision_checking_element != nullptr)
  {
    ...
    status = delay_collision_checking_element->QueryBoolText(&delay_collision_checking);
    if (status != tinyxml2::XML_NO_ATTRIBUTE && status != tinyxml2::XML_SUCCESS)
      throw std::runtime_error("OMPLConfigurator: BITstar: Error parsing DelayCollisionChecking string");
  }
}

ompl::base::PlannerPtr BITstarConfigurator::create(ompl::base::SpaceInformationPtr si) const
{
...
OMPLPlannerType BITstarConfigurator::getType() const { return OMPLPlannerType::BITstar; }

tinyxml2::XMLElement* BITstarConfigurator::toXML(tinyxml2::XMLDocument& doc) const
{
  tinyxml2::XMLElement* ompl_xml = doc.NewElement("kBITstar");
...
ABITstarConfigurator::ABITstarConfigurator(const tinyxml2::XMLElement& xml_element)
{
  const tinyxml2::XMLElement* bit_star_element = xml_element.FirstChildElement("ABITstar");
  const tinyxml2::XMLElement* range_element = bit_star_element->FirstChildElement("Range");
  const tinyxml2::XMLElement* goal_bias_element = bit_star_element->FirstChildElement("GoalBias");
  const tinyxml2::XMLElement* delay_collision_checking_element = bit_star_element->FirstChildElement("DelayCollisionChe"
                                                                                                     "cking");
...
ompl::base::PlannerPtr ABITstarConfigurator::create(ompl::base::SpaceInformationPtr si) const
{
  auto planner = std::make_shared<ompl::geometric::ABITstar>(si);
  //planner->setRange(range);
  //planner->setGoalBias(goal_bias);
  //planner->setDelayCC(delay_collision_checking);
  return planner;
...
OMPLPlannerType ABITstarConfigurator::getType() const { return OMPLPlannerType::ABITstar; }

tinyxml2::XMLElement* ABITstarConfigurator::toXML(tinyxml2::XMLDocument& doc) const
{
  tinyxml2::XMLElement* ompl_xml = doc.NewElement("ABITstar");
...
AITstarConfigurator::AITstarConfigurator(const tinyxml2::XMLElement& xml_element)
{
  const tinyxml2::XMLElement* bit_star_element = xml_element.FirstChildElement("AITstar");
  const tinyxml2::XMLElement* range_element = bit_star_element->FirstChildElement("Range");
  const tinyxml2::XMLElement* goal_bias_element = bit_star_element->FirstChildElement("GoalBias");
  const tinyxml2::XMLElement* delay_collision_checking_element = bit_star_element->FirstChildElement("DelayCollisionChe"
                                                                                                     "cking");
...
ompl::base::PlannerPtr AITstarConfigurator::create(ompl::base::SpaceInformationPtr si) const
{
...
OMPLPlannerType AITstarConfigurator::getType() const { return OMPLPlannerType::AITstar; }

tinyxml2::XMLElement* AITstarConfigurator::toXML(tinyxml2::XMLDocument& doc) const
{
  tinyxml2::XMLElement* ompl_xml = doc.NewElement("AITstar");
