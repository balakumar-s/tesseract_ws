...
struct BITstarConfigurator : public OMPLPlannerConfigurator
{
  BITstarConfigurator() = default;
  ~BITstarConfigurator() override = default;
  BITstarConfigurator(const BITstarConfigurator&) = default;
  BITstarConfigurator& operator=(const BITstarConfigurator&) = default;
  BITstarConfigurator(BITstarConfigurator&&) = default;
  BITstarConfigurator& operator=(BITstarConfigurator&&) = default;
  BITstarConfigurator(const tinyxml2::XMLElement& xml_element);
...
struct ABITstarConfigurator : public OMPLPlannerConfigurator
{
  ABITstarConfigurator() = default;
  ~ABITstarConfigurator() override = default;
  ABITstarConfigurator(const ABITstarConfigurator&) = default;
  ABITstarConfigurator& operator=(const ABITstarConfigurator&) = default;
  ABITstarConfigurator(ABITstarConfigurator&&) = default;
  ABITstarConfigurator& operator=(ABITstarConfigurator&&) = default;
  ABITstarConfigurator(const tinyxml2::XMLElement& xml_element);
...
struct AITstarConfigurator : public OMPLPlannerConfigurator
{
  AITstarConfigurator() = default;
  ~AITstarConfigurator() override = default;
  AITstarConfigurator(const AITstarConfigurator&) = default;
  AITstarConfigurator& operator=(const AITstarConfigurator&) = default;
  AITstarConfigurator(AITstarConfigurator&&) = default;
  AITstarConfigurator& operator=(AITstarConfigurator&&) = default;
  AITstarConfigurator(const tinyxml2::XMLElement& xml_element);
